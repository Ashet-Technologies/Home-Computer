...
module conn_cinch_female()
{
    ...
    rotate(180, [ 0, 0, 1 ]) translate([ -5, -10, -3.8 ]) rotate(90, [ 0, 0, 1 ]) rotate(90, [ 1, 0, 0 ])
        import("cinch_rcj-041.stl");
}
...
module dev_ikea_vaerdera()
{
    // https://www.ikea.com/de/de/p/vaerdera-becher-weiss-10277366/
    $fs = 0.1;
    $fa = 10;
    hs1 = 30;
    hs2 = 75;
...
module case_rm2095l(fp = true,bot=false)
{
    // https://www.hammfg.com/electronics/small-case/plastic/rm2
    if(bot)
    {
        import("rm2095l_bottom_part.stl");
    }
    else if (fp)
    {
        import("rm2095l.stl");
    ...
    {
        import("rm2095l_no_frontplate.stl");
    }
}

module case_rm2095l_fp()
{
    import("rm2095l_frontplate.stl");
}

module conn_pcie_x4()
{
    translate([ 0, 0, 0]) rotate(90, [ 0, 0, 1 ]) rotate(90, [ 1, 0, 0 ]) import("pcie_x4_10018784-10201TLF.stl");
}

module screw_m2_5_4mm()
{
    import("10294970.stl");
}