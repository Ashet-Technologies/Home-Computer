...
#include "img/mountains_640x480_rgb332.h"
#include "img/mountains_800x480_rgb332.h"

#define framebuf mountains_800x480
...
// Modeline "800x480R"   28.25  800 848 880 960  480 483 493 499 +hsync -vsync
